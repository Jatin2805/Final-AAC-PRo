      ...
      {/* <section className="web container" id="about"> */}
        ...
        <section className="web container" id="education">
          <div>
            ...
            <div>
              <h2 className="heading" style={{color:"black"}}>Our Story</h2>
              <p style={{color: 'indigo'}}>This competition held annually and prize are awarded to the winners, who are selected by a panel 
          ...
          <section className="web container" id="accomplishments">
            ...
            <section className="web container" id="activities">
              <h2 className="heading" style={{color:"black"}}>Events</h2>
              <link href="events.css" rel="stylesheet" type="text/css" />
              <p style={{color: 'indigo'}}>Some of the best events to look forward to!!</p>
<div >
                <div >
                    <h2 style={{color:'black'}}>Spices Events</h2>
